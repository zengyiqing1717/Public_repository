...
public class DietRecordController extends BaseController
{
     ...
     * 查询饮食记录列表
     */
    @PreAuthorize("@ss.hasPermi('diet:diet:list')")
    @GetMapping("/list")
     ...
     * 导出饮食记录列表
     */
    @PreAuthorize("@ss.hasPermi('diet:diet:export')")
     ...
     * 获取饮食记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('diet:diet:query')")
    @GetMapping(value = "/{id}")
    public AjaxResult getInfo(@PathVariable("id") Long id)
    {
        return success(dietRecordService.selectDietRecordById(id));
    }

    /**
     * 新增饮食记录
     */
    @PreAuthorize("@ss.hasPermi('diet:diet:add')")
     ...
     * 修改饮食记录
     */
    @PreAuthorize("@ss.hasPermi('diet:diet:edit')")
     ...
     * 删除饮食记录
     */
    @PreAuthorize("@ss.hasPermi('diet:diet:remove')")
